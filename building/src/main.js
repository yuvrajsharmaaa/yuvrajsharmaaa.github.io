...
function init() {
  var segments = 2;
  for (var i = 1; i < 120; i++){
    var geometry = new THREE.BoxGeometry(1,0.8,0.8,segments,segments,segments);
...
var gridHelper = new THREE.GridHelper(60, 20, 0xF00000, 0x000000);
city.add(gridHelper);
...
var createCars = function(cScale = 2, cPos = 20, cColor = 0xFFFF00) {
  ...
  if (createCarPos) {
    ...
    TweenMax.to(cElem.position, 5, {z:cPos, repeat:-1, yoyo:true, delay:mathRandom(3), ease:Power1});
  }
